...
export default {
  ...
  methods: {
    ...
    fileUpload(event){
      ...
      let windowURL = window.URL || window.webkeitUrl;
...
<style lang="scss">
  ...
  .img{ border:1px solid #ccc; width:200px; height:200px; display:flex; justify-content:center; align-items: center;
    img{ min-width:100%;}
  }
  .imgList{
    li{ width:100px; border:1px solid #ccc; margin:10px;
      >img{
        width:100%;
      }
    }
